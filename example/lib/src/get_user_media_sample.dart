...
class _GetUserMediaSampleState extends State<GetUserMediaSample> {
  ...
  List<MediaDeviceInfo> _mediaDevicesList = <MediaDeviceInfo>[];
  ...
  List<PopupMenuItem<String?>> buildAudioMediaList() {
    var audioMediaList = _mediaDevicesList
